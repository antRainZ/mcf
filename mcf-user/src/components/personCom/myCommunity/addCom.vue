...
export default {
  ...
  data(){
    return {
      ...
      form: {
        // 
        cover:  'https://wxgmcf.oss-cn-beijing.aliyuncs.com/avatar/176c5cef439a420d96850ab2d7901cfa.jpg',
        title: 'test111',
        description: 'test111',
        reason: 'test111',
        fileUrl: 'https://wxgmcf.oss-cn-beijing.aliyuncs.com/apply/435698a856444c989bab8e0df48cf7c3.docx'
      }
    }
  },
  methods: {
